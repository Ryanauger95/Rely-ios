...
class RequestModel {
    ...
    init (payer : User, collector : User, originator: Int, totalAmount: Double, reserveAmount: Double,  description: String) {
        self.payer = payer
    ...
    convenience init?(requestBuilder: RequestBuilder) {
        self.init(payer : requestBuilder.payer!, collector : requestBuilder.collector!, originator: requestBuilder.originator, totalAmount: requestBuilder.totalAmount!, reserveAmount: requestBuilder.reserveAmount!,  description: requestBuilder.description!)
    }
